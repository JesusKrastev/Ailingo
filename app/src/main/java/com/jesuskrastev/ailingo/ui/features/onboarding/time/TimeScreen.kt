package com.jesuskrastev.ailingo.ui.features.onboarding.time
...
fun TimeScreen(
    ...
    Column(
        ...
        Title(
            modifier = Modifier,
            text = "¿Cuánto tiempo tienes para practicar?",
        )
        Subtitle(
            text = "Elige tu objetivo de aprendizaje diario. Puedes cambiarlo cuando quieras.",
        )
        times.forEach { time ->
            Time(
                title = time.title,
